            ...
            <div>
                ...
                <table style="width: 642px">
                    ...
                    <tr>
                        ...
                        <td rowspan="4 " class="text-left align-middle">(+62) {{$cv->no_telepon}}</td>
        ...
        <div>
            ...
            <table style="width: 837px">
                @foreach ($cv->pendidikans as $p)
                    <tr class="text-center">
                        <td style="width:70px">{{ $p->tahun_masuk }} 年X月</td>
                        <td style="width:70px">-</td>
                        <td style="width:69px">{{ $p->tahun_lulus }} 年X月</td>
            ...
            <table style="width: 837px">
                @foreach ($cv->pengalamans as $p)
                    <tr class="text-center">
                        <td style="width:70px">{{ $p->tanggal_masuk }} 年X月</td>
                        <td style="width:70px">-</td>
                        <td style="width:69px">{{ $p->tanggal_keluar }} 年X月</td>
