...
<body class="p-4">
 <div class="btn-container mb-3">
    ...
    <div class="" style="display: flex; justify-content: center; gap: 1rem">
        <div class="container" id="cvArea">
            ...
            <table border="1" cellspacing="0" cellpadding="2" style="width: 450px; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <!-- Label bawah -->
                    <tr>
                        <td style="text-align:center;">Nama Belakang</td>
                        <td style="text-align:center;">Nama Depan</td>
                    </tr>
            ...
            <!-- ========================= -->
            <table border="1" cellspacing="0" style="width: 450px; border-collapse: collapse; margin-top: 1rem;">
                <thead>
                    <tr>
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 0; text-align: center;">
                                ...
                                @else
                                    <span style="font-size: 11px; color: #555;">Tidak ada foto</span>
                                @endif
                            </td>
                        </tr>
