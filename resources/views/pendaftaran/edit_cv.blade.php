                            ...
                            <div class="row mb-3 p-3 rounded pendidikan-item ">
                                ...
                                <div class="col-md-3 mb-2">
                                    <input type="text" name="pendidikan_tahun[]" class="form-control"
                                        value="{{ $pend->tahun }}" placeholder="Tahun Lulus">
                                </div>
                            ...
                            <div class="row mb-3 p-3 rounded kerja-item ">
                                ...
                                <div class="col-md-4 mb-2">
                                    <input type="text" name="kerja_perusahaan[]" class="form-control"
                                        value="{{ $kerja->perusahaan }}" placeholder="Nama Perusahaan">
                                </div>

                                <div class="col-md-4 mb-2">
                                    <input type="text" name="kerja_jabatan[]" class="form-control"
                                        value="{{ $kerja->jabatan }}" placeholder="Jabatan">
                                </div>

                                <div class="col-md-3 mb-2">
                                    <input type="text" name="kerja_tahun[]" class="form-control"
                                        value="{{ $kerja->lama_bekerja }}" placeholder="Lama Bekerja">
                                </div>
