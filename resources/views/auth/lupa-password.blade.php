...
<body class="min-h-screen bg-slate-100 flex items-center justify-center p-4">
    ...
    <div class="flex flex-col md:flex-row bg-white rounded-2xl shadow-2xl overflow-hidden max-w-4xl w-full">
        ...
        <div class="bg-gradient-to-br from-primary to-secondary p-8 md:p-12 flex flex-col items-center justify-center text-white w-full md:w-1/2">
            ...
            <h2 class="text-2xl md:text-3xl font-bold text-center mb-2">Reset Password</h2>
            <p class="text-sm text-white/80 text-center">Atur ulang password akun Anda dengan mudah.</p>
        ...
        <div class="p-8 md:p-12 w-full md:w-1/2 flex flex-col justify-center max-h-[90vh] overflow-y-auto">
            ...
            <h3 class="text-2xl font-bold text-primary mb-1">Lupa Password?</h3>
            <p class="text-gray-500 text-sm mb-6">Masukkan email dan password baru Anda</p>
            ...
            <form id="forgot-password-form" class="space-y-4">
                ...
                <!-- Password Baru -->
                <div>
                    <label class="block text-sm font-semibold text-primary mb-2">Password Baru</label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
                            <i class="bi bi-lock-fill text-lg"></i>
                        </span>
                        <input type="password" name="password" id="passwordInput" placeholder="Masukkan password baru" required
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password_confirmation" id="confirmPasswordInput" placeholder="Konfirmasi password baru" required
                            class="w-full pl-12 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all">
                ...
                <!-- Submit Button -->
                <button type="submit" id="btnReset" class="w-full bg-primary text-white py-3 rounded-xl font-semibold hover:bg-secondary transition-all hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none mt-6">
                    <i class="bi bi-arrow-clockwise mr-2"></i> Reset Password
                </button>
            </form>
            ...
            $('#forgot-password-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $btn.prop("disabled", false).html('<i class="bi bi-arrow-clockwise mr-2"></i> Reset Password');
