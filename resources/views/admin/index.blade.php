        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                <div class="col-12 col-md-6 col-lg-6">
                    <label for="filterRole" class="form-label fw-semibold text-secondary">Filter Berdasarkan Role</label>
                    <input type="text" id="filterRole" class="form-control shadow-sm rounded-3 border-1" placeholder="Masukkan role...">
                </div>
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped table-bordered align-middle nowrap" id="tableAdmin" style="width:100%">
                ...
                <tbody>
                    @php
                        $admins = [
                            ['name' => 'Rian Purnama', 'email' => 'rian@admin.com', 'role' => 'super admin', 'created_at' => '2025-01-02', 'updated_at' => '2025-02-05'],
                            ['name' => 'Siti Nurhaliza', 'email' => 'siti@admin.com', 'role' => 'admin cianjur', 'created_at' => '2025-03-10', 'updated_at' => '2025-03-25'],
                            ['name' => 'Ahmad Fauzi', 'email' => 'ahmad@admin.com', 'role' => 'admin cianjur selatan', 'created_at' => '2025-04-01', 'updated_at' => '2025-04-15'],
                            ['name' => 'Budi Santoso', 'email' => 'budi@admin.com', 'role' => 'admin cianjur', 'created_at' => '2025-06-05', 'updated_at' => '2025-06-22'],
                            ['name' => 'Rizky Ramadhan', 'email' => 'rizky@admin.com', 'role' => 'admin cianjur selatan', 'created_at' => '2025-07-10', 'updated_at' => '2025-07-20'],
                            ['name' => 'Anisa Rahma', 'email' => 'anisa@admin.com', 'role' => 'super admin', 'created_at' => '2025-08-01', 'updated_at' => '2025-08-15'],
                        ];
                    @endphp
                    ...
                    @foreach ($admins as $index => $admin)
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($admin['role'] == 'admin cianjur')
                                    <span class="badge bg-success">{{ ucfirst($admin['role']) }}</span>
                                @elseif($admin['role'] == 'admin cianjur selatan')
