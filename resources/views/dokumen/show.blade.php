                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1"><i class="bi bi-check-circle-fill me-2 text-warning"></i>Status
                                        Verifikasi: {{ ucfirst($kandidat->verifikasi) }}</p>
                                    @if ($kandidat->catatan_admin)
                                        <p class="mb-1"><i
                                                class="bi bi-chat-left-text-fill me-2 text-secondary"></i>Catatan Admin:
                    ...
                    <div class="row g-3">
                        @php
                            $dokumenList = [
                                ...
                                [
                                    'label' => 'Ijazah',
                                    'file' => $kandidat->ijasah,
                                    'color' => 'success',
                                    'icon' => 'bi-mortarboard',
                                ],
                                [
                                    'label' => 'Bukti Pelunasan',
                                    'file' => $kandidat->bukti_pelunasan,
                                    'color' => 'warning',
                                    'icon' => 'bi-receipt',
                                ],
                                [
