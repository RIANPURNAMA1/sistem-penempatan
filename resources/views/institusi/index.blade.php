...
<div class="">
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                <div class="col-12 col-md-6 col-lg-6">
                    ...
                    <input type="text" id="filterKota" class="form-control shadow-sm rounded-3 border-1" placeholder="Masukkan nama kota...">
                </div>
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body table-responsive">
            <table class="table table-striped table-bordered align-middle nowrap" id="tableInstitusi" style="width:100%">
                ...
                <tbody>
                    @for ($i = 1; $i <= 50; $i++)
                        @php
                            $kotaList = ['Bandung', 'Jakarta', 'Cirebon', 'Bogor', 'Karawang', 'Tasikmalaya'];
                            $alamat = 'Jl. Merdeka No.' . $i . ', ' . $kotaList[array_rand($kotaList)];
                            $kuota = rand(5, 50);
                        @endphp
                        <tr>
                            <td>{{ $i }}</td>
