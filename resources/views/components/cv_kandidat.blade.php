                   ...
                   <div class="card-body">
                       @foreach ($cvs as $cv)
                               ...
                               <table class="table table-bordered table-striped align-middle table-sm">
                                   <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               @if ($cv->pas_foto_cv)
                                                   <img src="{{ asset($cv->pas_foto_cv) }}" width="200"
                                                       alt="Foto CV">
                                               @else
                                       ...
                                       @php
                                           $hiddenFields = [
                                               ...
                                               [
                                                   'Biaya Keberangkatan Jisshu',
                                                   $cv->Biaya_keberangkatan_sebelumnya_jisshu ?? '-',
                                               ],
                                                   ...
                                                   @foreach ($cv->pendidikans as $index => $pendidikan)
                                                       <div class="mb-3 p-3 border rounded">
                                                           ...
                                                           @if ($pendidikan->tahun_masuk)
                                                               ...
                                                               {{ $pendidikan->tahun_masuk }}<br>
                                                           @endif

                                                           @if ($pendidikan->tahun_lulus)
                                                               <strong>Tahun Lulus:</strong>
                                                               {{ $pendidikan->tahun_lulus }}<br>
                                                           @endif
                                                       ...
                                                       <div class="mb-3 p-3 border rounded bg-light">
                                                           ...
                                                           @else
                                                               <strong>Status:</strong> <span
                                                                   class="badge bg-success">Masih
                                                                   Bekerja</span><br>
                                                           @endif

                                                           @if ($pengalaman->tanggal_masuk && $pengalaman->tanggal_keluar)
                                                               @php
                                                                   $masuk = \Carbon\Carbon::parse(
                                                                       $pengalaman->tanggal_masuk,
                                                                   );
                           ...
                           <a href="{{ route('pendaftaran.cv.edit', $cv->id) }}"
                               class="btn btn-sm fw-semibold mb-3 text-white"
                               style="background-color: #01040e; border-color: #01040e;">
