...
<div class="py-4">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted fst-italic">Masukkan data cabang baru pada form berikut.</p>
    </div>

    <!-- Form Card -->
    <div class="card shadow-sm rounded-4">
        <div class="card-body">
            <form id="formTambahCabang">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="alamat" id="alamat" class="form-control" rows="3" placeholder="Masukkan alamat cabang" required></textarea>
                </div>
...
$(document).ready(function() {
    $('#formTambahCabang').submit(function(e) {
        e.preventDefault();

        let form = $(this);
        let btn = $('#btnSubmit');

        // Tambah loading spinner
