...
class CvController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ============================================================ */
            ...
            // Simpan Tujuan Setelah Pulang dari Jepang
            TujuanSetelahPulang::updateOrCreate(
                ['cv_id' => $cv->id],
                ['tujuan_setelah_pulang' => $request->tujuan_setelah_pulang]
            );

            // Simpan gaji keluarga ke tabel terpisah
            GajiKeluarga::updateOrCreate(
                ['cv_id' => $cv->id],
                [
                    'istri_gaji' => $request->istri_gaji,
                    'ibu_gaji' => $request->ibu_gaji,
                    'ayah_gaji' => $request->ayah_gaji,
                    'kakak_gaji' => $request->kakak_gaji,
                    'adik_gaji' => $request->adik_gaji,
                ]
            );
    ...
    public function updatecvkandidat(Request $request, $id)
    {
        ...
        ============================================================ */
            ...
            // Update/Hapus then Create gaji keluarga ke tabel terpisah
            GajiKeluarga::updateOrCreate(
                ['cv_id' => $cv->id],
                [
                    'istri_gaji' => $request->istri_gaji,
