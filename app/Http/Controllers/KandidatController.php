...
class KandidatController extends Controller
{
    ...
    ------------------------------------------------------------ */
        ...
        /* ------------------------------------------------------------
    | 🔔 Kirim WhatsApp via FonnteService
    ------------------------------------------------------------ */
        $noWa = $kandidat->pendaftaran->no_wa ?? null;
        $nama = $kandidat->pendaftaran->nama ?? $kandidat->nama;
        ...
        if (!empty($noWa)) {
            ...
            $pesan =
                ...
                "Apabila Anda membutuhkan informasi tambahan, jangan ragu untuk menghubungi tim *Mendunia Jepang*.\n\n" .
